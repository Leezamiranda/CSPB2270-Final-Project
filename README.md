...
Alternately, you can use the CSEL environment's JupyterHub to do everything in a web browser without installing anything on your local computer. Here's how.
